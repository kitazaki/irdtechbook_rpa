...
はじめまして！ 筆者は普段通信事業者として商用設備の運用保守業務を担当しております。運用保守業務を実施されたことのある方であれば経験があるかと思いますが、保守しているシステムの不具合や故障(これらを以下、インシデントと記載)の対処を日々実施していく必要があります。この業務を滞りなく遂行していくには情報の扱いを出来る限り自動にしていく事が望ましいです。
